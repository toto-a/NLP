...
from torch.utils.data import Datasets,DataLoader ,random_split
from torch.utils.tensorboard import SummaryWriter

from datasets import BilingualDatasets,causal_mask
...
def get_ds(config):
    ...
    for item  in ds_raw:
        ...
        tgt_ids=tokenizer_src.decode(item['translation'][config["lang_tgt"]]).ids
